...
export default function Home() {
  return (
    <div>
      <Hero />
      {/* Trust Stats */}
      <section className="py-8 px-6 sm:px-8 lg:px-10 bg-secondary text-white">
        <div className="mx-auto max-w-7xl grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <div className="text-3xl font-bold">7</div>
            <div className="text-sm text-white/80">Projects Listed</div>
          </div>
          <div>
            <div className="text-3xl font-bold">R33.88M</div>
            <div className="text-sm text-white/80">Combined Project Value</div>
          </div>
          <div>
            <div className="text-3xl font-bold">6</div>
            <div className="text-sm text-white/80">Water Infrastructure Projects</div>
          </div>
          <div>
            <div className="text-3xl font-bold">Sectors</div>
            <div className="text-sm text-white/80">Municipal, Eskom, Rand Water, Umngeni Water</div>
          </div>
        </div>
      </section>
